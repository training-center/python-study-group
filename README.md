...
Este grupo se destina ao estudo de Python.
...
Basta entrar no [Slack do Training Center](https://github.com/training-center/slack) e entrar no canal **#python-studies**.
...
Caso você precise entrar em contato com as pessoas responsáveis por este grupo de estudos, pode chamar por `@cvalente` no Slack do Training Center.
